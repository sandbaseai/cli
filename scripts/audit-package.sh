...
while IFS= read -r entry; do
  case "$entry" in
    package/package.json|package/README.md|package/README.de.md|package/README.es.md|package/README.fr.md|package/README.ja.md|package/README.ko.md|package/README.pt-BR.md|package/README.zh-CN.md|package/LICENSE|package/assets/mcp-bridge.mjs|package/assets/skills/sandbase/SKILL.md|package/dist/*.js|package/dist/*.d.ts)
      ;;
    *)
...
for required in package/package.json package/README.md package/README.de.md package/README.es.md package/README.fr.md package/README.ja.md package/README.ko.md package/README.pt-BR.md package/README.zh-CN.md package/LICENSE package/assets/mcp-bridge.mjs package/assets/skills/sandbase/SKILL.md package/dist/cli.js; do
